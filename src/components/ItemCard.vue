...
const options = [
  ...
  },
  {
    ...
    disabled: isTop(),
    icon: () =>
      h(NIcon, { class: 'rotate-90' }, { default: () => h(leftIcon) }),
  },
  {
    label: '置顶',
    key: 'top',
    disabled: isTop(),
    icon: () =>
      h(NIcon, { class: 'rotate-90' }, { default: () => h(leftDoubleIcon) }),
  },
  {
    label: '下移',
    key: 'down',
    disabled: isBottom(),
    icon: () =>
      h(NIcon, { class: 'rotate-270' }, { default: () => h(leftIcon) }),
  },
  {
    label: '置底',
    key: 'bottom',
    disabled: isBottom(),
    icon: () =>
      h(NIcon, { class: 'rotate-270' }, { default: () => h(leftDoubleIcon) }),
  },
]
